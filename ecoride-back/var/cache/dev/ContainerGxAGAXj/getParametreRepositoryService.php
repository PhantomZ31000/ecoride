 ...
 */
class getParametreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ParametreRepository' shared autowired service.
     *
     * @return \App\Repository\ParametreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ParametreRepository.php';

        return $container->privates['App\\Repository\\ParametreRepository'] = new \App\Repository\ParametreRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
