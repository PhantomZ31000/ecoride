 ...
 */
class getDisposeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\DisposeRepository' shared autowired service.
     *
     * @return \App\Repository\DisposeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DisposeRepository.php';

        return $container->privates['App\\Repository\\DisposeRepository'] = new \App\Repository\DisposeRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
