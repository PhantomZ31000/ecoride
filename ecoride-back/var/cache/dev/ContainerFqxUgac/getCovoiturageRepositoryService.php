 ...
 */
class getCovoiturageRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CovoiturageRepository' shared autowired service.
     *
     * @return \App\Repository\CovoiturageRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CovoiturageRepository.php';

        return $container->privates['App\\Repository\\CovoiturageRepository'] = new \App\Repository\CovoiturageRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
