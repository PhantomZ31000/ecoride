...
class getLoginFormAuthenticator2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['debug.App\\Security\\LoginFormAuthenticator'])) {
            return $container->privates['debug.App\\Security\\LoginFormAuthenticator'];
        }

        return $container->privates['debug.App\\Security\\LoginFormAuthenticator'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticator($a);
    }
}
