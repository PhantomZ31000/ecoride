...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AccueilController', 'App\\Controller\\AuthentificationController', 'App\\Controller\\AvisController', 'App\\Controller\\CovoiturageController', 'App\\Controller\\ProfilController', 'App\\Controller\\PropositionController', 'App\\Controller\\RechercheController', 'App\\Controller\\VoitureController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getApiPlatform_Symfony_IriConverterService($container)
    {
        ...
        $f = ($container->privates['api_platform.resource_class_resolver'] ?? self::getApiPlatform_ResourceClassResolverService($container));

        return $container->privates['api_platform.symfony.iri_converter'] = new \ApiPlatform\Symfony\Routing\IriConverter($a, ($container->privates['api_platform.router'] ?? self::getApiPlatform_RouterService($container)), new \ApiPlatform\Metadata\IdentifiersExtractor($b, $f, $c, ($container->privates['api_platform.metadata.property.metadata_factory.cached'] ?? self::getApiPlatform_Metadata_Property_MetadataFactory_CachedService($container)), ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container))), $f, $b, $d, ($container->privates['api_platform.symfony.iri_converter.skolem'] ?? self::getApiPlatform_Symfony_IriConverter_SkolemService($container)), $e);
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $i = new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL, $container->parameters['api_platform.serializer.default_context']);

        $j = new \ApiPlatform\OpenApi\Serializer\LegacyOpenApiNormalizer(new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $g, $a)], [$i]))));
        $k = ($container->privates['api_platform.hydra.name_converter.hydra_prefix'] ?? self::getApiPlatform_Hydra_NameConverter_HydraPrefixService($container));
        ...
        $o = new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $l, $d, $m, $e, $g, $k, $n, $container->parameters['api_platform.serializer.default_context'], $f, NULL);
        ...
        $r = new \ApiPlatform\Serializer\ItemNormalizer($c, $l, $d, $m, $g, $k, $n, NULL, $b, $f, [], NULL);
        ...
        $v = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $t, $g, $a, $u, NULL, [], $a);
        ...
        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Serializer\ConstraintViolationListNormalizer([], $k), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer([], $k, $container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($j, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($p, $k), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $l, $m, $q, $k, $container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $d, $q), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Symfony\Validator\Serializer\ValidationExceptionNormalizer($r, $k), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($p, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, $container->parameters['api_platform.serializer.default_context'], $s), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer($container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($o, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($r, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer($container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer($container->parameters['api_platform.serializer.default_context'], $t), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($n, $t, $a, $u, NULL, [])), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer($container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($s, $container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL, $container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($e, $m, $d, NULL, $container->parameters['api_platform.serializer.default_context']), 'page', 'pagination', $b, $g, 1, $container->parameters['api_platform.serializer.default_context']), $b, $m, ($container->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [], [])), $container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($v, $d, $e), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableNormalizer($v, $h, 'default')], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder($container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($i, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder($w, $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder($container->parameters['api_platform.serializer.default_context']), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonopenapi', NULL), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\YamlEncoder('yamlopenapi', $w), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), $h, 'default'), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \ApiPlatform\Serializer\JsonEncoder('jsonproblem'), $h, 'default')], $container->parameters['api_platform.serializer.default_context']), $h, 'default');
    }
